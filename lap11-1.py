def Login():
    ...
    if username == "admin" and password == "1234" :
        messagebox.showinfo(title ="ถูกต้อง", message = "ถูกต้อง")
    else :
        messagebox.showerror(title ="ไม่ถูกต้อง", message = "ไม่ถูกต้อง")
...
lb1.place(x=70, y=40)
lb2 = Label(main, text="password", font=("FreesiaUPC",20))
